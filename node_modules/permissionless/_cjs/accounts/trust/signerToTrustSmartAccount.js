...
async function signerToTrustSmartAccount(client, { signer, factoryAddress = exports.TRUST_ADDRESSES.factoryAddress, entryPoint: entryPointAddress, index = 0n, secp256k1VerificationFacetAddress = exports.TRUST_ADDRESSES.secp256k1VerificationFacetAddress, address }) {
    const viemSigner = {
        ...signer,
