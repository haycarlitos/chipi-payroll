 ...
 */
export async function signerToTrustSmartAccount(client, { signer, factoryAddress = TRUST_ADDRESSES.factoryAddress, entryPoint: entryPointAddress, index = 0n, secp256k1VerificationFacetAddress = TRUST_ADDRESSES.secp256k1VerificationFacetAddress, address }) {
    const viemSigner = {
        ...signer,
